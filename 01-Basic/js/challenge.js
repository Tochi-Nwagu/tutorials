...
// if (bill >= 50 && bill <= 300) {
//   console.log(`the bill was ${bill}, and tip was ${bill * 0.15}, and the total value ${bill + bill * 0.15
//     } `);
// } else {
//   console.log(`the bill was ${bill}, and tip was ${bill * 0.2}, and the total value ${bill + bill * 0.2} `);
// }
...
// // console.log(calcAverage(65, 44, 41));
// const scoreDolphins = calcAverage(44, 23, 71);
// const scoreKoalas = calcAverage(65, 54, 49);
